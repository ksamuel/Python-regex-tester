...
open('MANIFEST.in', 'w').write('\n'.join((
    ...
    "recursive-include %s *.py" % os.path.join(src_directory, 'views')
)))
...
setup(
    ...
    description="Python online regex tester for Python 2.7+",
    ...
    #
    long_description=strip_non_ascii(open('README.rst').read().decode('utf8')),
    ...
    url="https://github.com/ksamuel/Python-regex-tester",
    ...
    scripts=[os.path.join(src_directory, 'regex_tester')],
